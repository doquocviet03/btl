@php($title = 'Thêm danh mục dịch vụ')
...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
    ...
    <form method="POST" action="{{ route('admin.danh-muc-dich-vu.store') }}" class="space-y-5">
        @include('admin.danh_muc_dich_vu.form', ['danhMucDichVu' => null])
    </form>
</div>
@endsection
