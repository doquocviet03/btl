@php($title = 'Sửa danh mục dịch vụ')
...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
    ...
    <form method="POST" action="{{ route('admin.danh-muc-dich-vu.update', $danhMucDichVu->id) }}" class="space-y-5">
        @method('PUT')
        @include('admin.danh_muc_dich_vu.form')
    </form>
</div>
@endsection
